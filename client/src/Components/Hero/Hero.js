...
class Hero extends Component {
    render(props) {
        return (
            <div>
                <LazyHero opacity={0.2} minHeight="60vh" isCentered={true} imageSrc="http://orogoldstorelocator.com/wp-content/uploads/2016/08/OROGOLD-Popular-German-Outdoor-Activities-Cycling.jpg" parallaxOffset={3} >
